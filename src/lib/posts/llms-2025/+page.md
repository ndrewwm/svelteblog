...
I would also argue that the above become _more_ true as organizations increase in size. In any case, they're some of the reasons why a lot of data analysis remains bespoke. ...
...
This is, frankly, dystopian under any reasonable reading. It's such a far cry from the DIY/hacker spirit I've encountered in the mentors I've been fortunate to have. While I struggle to articulate it, the attitude within this manifesto just fills me with a deep dread. It's an insult to the idea of learning for its own sake. It's part of a chorus of voices in our society encouraging us to offload our thinking-- _why bother? A model can do it._ It's a startup with Captain Beatty as CEO:

> "School is shortened, discipline relaxed, philosophies, histories, languages dropped, English and spelling gradually neglected, finally almost completely ignored. Life is immediate, the job counts, pleasure lies all about after work. Why learn anything save pressing buttons, pulling switches, fitting nuts and bolts."

### More in [part 2.](/blog/post/llms-2025-part-2)

This post has ended up having a much longer word count than planned. I'd intended something fairly breezy, two paragraphs max for each topic. At this point, I think I could've written individual posts for each of these. A downside of not writing regularly and letting one's thoughts accumulate, I suppose. In part 2, I'll conclude with how my thoughts have been _adjusting_ with regards to model collapse, and the environmental impacts of LLMs.
